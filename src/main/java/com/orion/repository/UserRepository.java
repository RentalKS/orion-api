...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("SELECT new com.orion.dto.UserData(u.id, u.firstname,u.lastname, u.email,u.createdAt) FROM User u WHERE u.id = :userId and u.deletedAt is null and u.deactivatedAt is null")
